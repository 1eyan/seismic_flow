...
set -euo pipefail
# =========================================================================
# Query-Context V2 推理 — self-supervised mode (gen_infer_5d.py)
#
# Usage:
#   Single-GPU:  ./run_queryctx_v2_infer.sh
#   Multi-GPU:   NPROC_PER_NODE=4 ./run_queryctx_v2_infer.sh
# =========================================================================
...
DATASET_NEIGHBORS_INFER="${DATASET_NEIGHBORS_INFER:-${DATA_DIR}/infer_query_context_v2.npz}"
...
# ---- Output ----
CHECKPOINT="${CHECKPOINT:-${ROOT_DIR}/resultsFPM/trace_axis_queryctx_v2/checkpoints/model-epoch-800.pth}"
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT_DIR}/gen_fill_results_queryctx_v2}"
...
echo "============================================================"
echo "Query-Context V2 Inference (gen_infer_5d.py)"
echo "============================================================"
