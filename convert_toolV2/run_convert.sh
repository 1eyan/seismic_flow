...
#IRR_SEGY="${IRR_SEGY:-/cloud/cloud-ssd2/测试数据/raw5d_data_updated/raw5d_data1104.sgy}"
#MASK_SEGY="${MASK_SEGY:-/cloud/cloud-ssd2/测试数据/mask_from_label.sgy}"
#LABEL_SEGY="${LABEL_SEGY:-/cloud/cloud-ssd2/测试数据/reg_pku_1031/reg_pku_1030/reg5dbin_label1031.sgy}"
...
DATASET_NAME="${DATASET_NAME:-sw06}"
